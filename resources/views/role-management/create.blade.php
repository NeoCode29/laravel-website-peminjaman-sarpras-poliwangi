...
@section('subtitle', 'Buat role baru untuk sistem')
...
<div class="role-management-container">
    ...
    <div class="card">
        <div class="card-header">
            <div class="card-header-content">
                <div class="card-header-title">
                    ...
                    <p class="subtitle">Buat role baru untuk mengatur permission pengguna</p>
                </div>
        ...
        <div class="card-main">
            <!-- Form Section -->
            <form method="POST" action="{{ route('role-management.store') }}" class="role-form">
                @csrf
