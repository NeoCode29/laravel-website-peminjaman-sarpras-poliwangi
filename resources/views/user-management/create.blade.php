...
@section('content')
<section class="detail-page create-user-page">
    <div class="card user-detail-card">
        <div class="card-main">
            <form id="createUserForm" method="POST" action="{{ route('user-management.store') }}" class="user-create-form">
                @csrf
                ...
                <div class="detail-card-grid">
                    <div class="form-section">
                        ...
                        <div class="detail-block form-grid">
                            ...
                            <div class="form-group">
                                <label for="phone" class="form-label required">Nomor Handphone</label>
                                <input type="tel"
                                       id="phone"
                                       name="phone"
                                       value="{{ old('phone') }}"
                    ...
                    <div class="form-section">
                        ...
                        <div class="detail-block form-grid">
                            <div class="form-group">
                                <label for="user_type" class="form-label required">Tipe User</label>
                                <select id="user_type"
                                        name="user_type"
                    ...
                    <div class="form-section user-type-section is-hidden" id="mahasiswa-section">
                        ...
                        <div class="detail-block form-grid">
                            ...
                            <div class="form-group">
                                <label for="prodi_id" class="form-label required">Program Studi</label>
                                <select id="prodi_id"
                                        name="prodi_id"
                    ...
                    <div class="form-section user-type-section is-hidden" id="staff-section">
                        ...
                        <div class="detail-block form-grid">
                            ...
                            <div class="form-group">
                                <label for="position_id" class="form-label required">Posisi/Jabatan</label>
                ...
                <div class="form-section">
                    ...
                    <div class="detail-actions">
                        <a href="{{ route('user-management.index') }}" class="btn btn-secondary btn-cancel">
