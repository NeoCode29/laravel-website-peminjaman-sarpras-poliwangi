...
@section('title', 'Buat Marking Baru')
@section('subtitle', 'Reservasi cepat sarpras tanpa harus menunggu pengajuan formal')
...
<section class="detail-page marking-form-page">
    <div class="card user-detail-card">
        <div class="card-main">
            <form method="POST" action="{{ route('marking.store') }}" id="markingForm" class="marking-form">
                @csrf
                        ...
                        <div class="detail-block form-grid form-grid--two">
                            ...
                            <div class="form-group form-group--full">
                                ...
                                <textarea id="notes"
                                          ...
                                          placeholder="Catatan tambahan untuk marking">{{ old('notes') }}</textarea>
                                @error('notes')
                                    <div class="form-error">{{ $message }}</div>
                                @enderror
                            </div>
                                ...
                                <div class="form-radio-group">
                                    <label class="form-radio-item">
                                        <input type="radio"
                                               name="location_type"
                                               value="prasarana"
                                               {{ old('location_type', 'prasarana') == 'prasarana' ? 'checked' : '' }}
                                    ...
                                    <label class="form-radio-item">
                                        <input type="radio"
                                               name="location_type"
                                               value="custom"
                                               {{ old('location_type') == 'custom' ? 'checked' : '' }}
                                               onchange="toggleLocationType()">
                                    ...
                                    <select id="prasarana_id"
                                        ...
                                        @foreach($prasaranas as $prasarana)
                                            <option value="{{ $prasarana->id }}"
                                                    ...
                                                    {{ old('prasarana_id') == $prasarana->id ? 'selected' : '' }}>
                                ...
                                <div class="sarana-item" data-name="{{ strtolower($sarana->name) }}">
                                    <label class="sarana-checkbox">
                                        <input type="checkbox"
                                               name="sarana_ids[]"
                                               value="{{ $sarana->id }}"
                                               {{ in_array($sarana->id, old('sarana_ids', [])) ? 'checked' : '' }}>
